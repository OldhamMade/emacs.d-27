...
#+BEGIN_SRC emacs-lisp :tangle yes
  (defhydra hydra-persp (:color pink :hint nil :timeout 3.0)
    "
   ^Perspectives^
  -^------------^---------------------^-^---------------------------------------
   [_s_] Switch project              [_r_] Rename perspective
   [_S_] Switch/create perspective   [_k_] Kill/remove buffer from perspective
   [_n_] Next perspective            [_K_] Kill perspective
   [_p_] Previous perspective        [_q_] Quit
  "
