...
*** Delight
delight hides or abbreviates minor mode indicators in the modeline
...
CMD + "up"/"down" feel quite natural to me for switching
between buffers
...
(add-hook 'elixir-mode-hook
          (lambda ()
            ...
            (set (make-variable-buffer-local 'ruby-end-check-statement-modifiers)
                 nil)
            (ruby-end-mode 1)
            (setq alchemist-mix-command "/Users/phillipoldham/.exenv/shims/mix")
...
**** Crystal
#--+BEGIN_SRC emacs-lisp :tangle yes
(add-to-list 'load-path (expand-file-name "custom/crystal-mode" dotfiles-dir))
(require 'crystal-mode)
(with-eval-after-load 'flycheck
  (flycheck-add-mode 'flycheck-crystal 'crystal-mode))
