...
**** Add =inf-elixir=
     ...
     (use-package inf-elixir
      ...
      :functions inf-elixir)
     #+END_SRC
**** Define custom alchemist keymaps
     Alchemist keys start with =C-c a=.
***** Run keymap
      #+BEGIN_SRC emacs-lisp :tangle yes
      (general-def
        :prefix-map 'my-alchemist-run-map
        "i" #'inf-elixir
        "I" #'alchemist-iex-run
        "g" #'alchemist-iex-send-region-and-go
        "c" #'alchemist-compile-this-buffer
        "C" #'alchemist-compile
        "e" #'alchemist-eval-current-line
        "E" #'alchemist-eval-region
        "b" #'alchemist-eval-buffer
        "B" #'alchemist-execute-buffer
        "f" #'elixir-format
        )

      (hercules-def
        :toggle-funs #'my-alchemist-run-mode
        :keymap 'my-alchemist-run-map
        :transient t
        :flatten t)

      (general-define-key
        :keymaps 'alchemist-mode-keymap
        "C-c a r" 'my-alchemist-run-mode)
      #+END_SRC
***** Mix keymap
      #+BEGIN_SRC emacs-lisp :tangle yes
      (general-def
        :prefix-map 'my-alchemist-mix-map
        "r" #'alchemist-mix
        "R" #'alchemist-mix-rerun-last-task
        "h" #'alchemist-hex-info
        "H" #'alchemist-hex-releases
        "." #'alchemist-hex-info-at-point
        "d" #'alchemist-hex-all-dependencies
        "s" #'alchemist-hex-search
        )

      (hercules-def
        :toggle-funs #'my-alchemist-mix-mode
        :keymap 'my-alchemist-mix-map
        :transient t
        :flatten t)

      (general-define-key
        :keymaps 'alchemist-mode-keymap
        "C-c a m" 'my-alchemist-mix-mode)
      #+END_SRC
***** Testing keymap
      #+BEGIN_SRC emacs-lisp :tangle yes
      (general-def
